...
// Short-form voice-recorder filenames:  D Mmm at HH-MM optional comment.(m4a|aac)
// e.g. "1 Apr at 17-46 bark bark.m4a"
const SHORT_FILENAME_RE =
  /^(\d{1,2}) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) at (\d{2})-(\d{2})(?:\s+(\S.*?))?\.(m4a|aac)$/i;
